...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher(){
        ...
        labelempid = new JLabel("221"+first4);
        ...
        JLabel lblcourse = new JLabel("Highest Degree");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            String dob = ((JTextField) dcdob.getDateEditor().getUiComponent()).getText(); //   type casting
